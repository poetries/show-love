function showTime() { 
	...
	var startDate = new Date(2013, 11, 11);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear jieying:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----poetries   2016-01-17</c>"; 
